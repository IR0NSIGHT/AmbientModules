/*
	...
	Examples:
		[myAAGun, -1, 3000] call IRN_fnc_aaAmbient;	//pure ambient AA that shoots at anything within 3 kms
		[myGunTruck, 1500,3000]  call IRN_fnc_aaAmbient; //AA will shoot ambient at anything within 3kms and kill anything within 1.5 kms
