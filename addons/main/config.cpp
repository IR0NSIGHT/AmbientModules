...
class CfgPatches {
    class ADDON {
        ...
        author = "IRN Team"; // primary author name, either yours or your team's, considered for the whole mod
        VERSION_CONFIG;
    };
};
...
class CfgMods {
    class PREFIX {
        ...
        author = "IRN Team";                    // probably shown somewhere in the mods menu, but probably ignored by CBA/HEMTT
